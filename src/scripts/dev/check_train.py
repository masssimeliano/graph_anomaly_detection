...
from src.scripts.dev import train_from_emd_baseline_with_alpha_1, train_and_save_emd_from_baseline_alpha_2, \
    train_and_save_emd_from_baseline_alpha_1, train_baseline, train_structure_and_feature, \
    train_structure_and_feature_2, train_structure_and_feature_3
