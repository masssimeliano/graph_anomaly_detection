"""
train_and_save_emd_from_baseline_alpha_1.py
This file contains script to train a feature model "Attr + Alpha1"
"""
...
from src.models.cola import baseline_alpha_model_1
